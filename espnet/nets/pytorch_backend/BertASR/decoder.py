...
from espnet.nets.pytorch_backend.LASO.decoder_layer import DecoderLayer
...
class Decoder(torch.nn.Module):
    ...
    def __init__(
        ...
        self.output_layer = torch.nn.Linear(attention_dim, 768)
    ...
    def get_positionwise_layer(
        ...
        if positionwise_layer_type == "linear":
            ...
            positionwise_layer_args = (attention_dim, linear_units, dropout_rate, F.glu)
    ...
    def forward(self, xs, masks):
        ...
        if self.intermediate_layers is None:
            ...
            for layer_idx, encoder_layer in enumerate(self.decoders):
