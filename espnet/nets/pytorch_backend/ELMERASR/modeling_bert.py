...
class BertEncoderForPermutation(BertEncoder):
...
class BertModelForPermutation(BertModel):
    def __init__(self, config, add_pooling_layer=True):
        super().__init__(config)
        self.config = config

        self.embeddings = BertEmbeddings(config)
        self.encoder = BertEncoderForPermutation(config)
...
class BertForMaskedLMForPermutation(BertForMaskedLM):
    def __init__(self, config):
        super().__init__(config)
        ...
        self.bert = BertModelForPermutation(config, add_pooling_layer=False)
