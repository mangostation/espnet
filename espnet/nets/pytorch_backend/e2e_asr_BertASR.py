...
class E2E(ASRInterface, torch.nn.Module):
    ...
    def __init__(self, idim, odim, args, ignore_id=-1):
        ...
        bertmodel = BertForMaskedLMForBERTASR.from_pretrained(PRETRAINED_MODEL_NAME)
        # print(123456789)
        # bertmodel = BertForMaskedLMForBERTASR.from_pretrained("/work/m11115119/espnet/egs/aishell/asr1/bert_BertASR/bert_permutation/checkpoint-10000")
