...
dec_ngpu=1
debugmode=1
dumpdir=/mnt/disk3/m11115119/espnet/egs/aishell/asr1/dump   # directory to dump full features
...
if [ ${stage} -le 5 ] && [ ${stop_stage} -ge 5 ]; then
    ...
    (
        ...
        ${decode_cmd} JOB=1:${nj} ${expdir}/${decode_dir}/log/decode.JOB.log \
            ...
            --backend ${backend} \
            --batchsize 0 \
            --recog-json ${feat_recog_dir}/split${nj}utt/data_bert_tmp.JOB.json \
            --result-label ${expdir}/${decode_dir}/data_bert_tmp.JOB.json \
            --model ${expdir}/results/${recog_model}  \
            --use-bert True
            # --rnnlm ${lmexpdir}/rnnlm.model.best \
            # ${recog_v2_opts}

        score_sclite_bert.sh ${expdir}/${decode_dir} ${dict}
